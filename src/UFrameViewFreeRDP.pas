...
type
  ...
  private
    ...
    function GetOption: TFreeRDPConnectionOptions;
  ...
  public
    ...
    property Options: TFreeRDPConnectionOptions read GetOption write SetOptions;
...
function TFrameViewFreeRDP.GetOption: TFreeRDPConnectionOptions;
begin
  Result := FFreeRDP.Options;
end;
